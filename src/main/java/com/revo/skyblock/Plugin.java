...
public class Plugin extends JavaPlugin {
    ...
    public void onEnable() {
        log.info(Constants.TAG + " Plugin - onEnable() - init application context");
        ...
        log.info(Constants.TAG + " Plugin - onEnable() - register events");
        ...
        log.info(Constants.TAG + " Plugin - onEnable() - register commands");
